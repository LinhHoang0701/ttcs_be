...
import { getAll, newBooking, checkTripIsAvailble, getBookedDates, myBookings, deleteBooking } from '../controllers/ticketController';
...
router.route("/check").post(checkTripIsAvailble);
