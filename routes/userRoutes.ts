...
import { getAll, register, login, updateUser, getSingleUser, deleteUser, updateProfile, updatePassword, forgotPassword, resetPassword, accessPaymentMethod, searchUser, getAccount } from '../controllers/userController';
...
router.route("/verifyPassword").post(protect, accessPaymentMethod);
