...
import { createVehicle, getAll, updateVehicle, deleteVehicle, getVehicle, getVehicleByCompanyId, searchVehicle } from "../controllers/vehicleController";
...
router.route('/getByCompanyId/:companyId').get(protect, admin, getVehicleByCompanyId);
